...
namespace Cheesesquare
{
    ...
    public class MainActivity : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        void setupViewPager(Android.Support.V4.View.ViewPager viewPager)
        {
            ...
            adapter.AddFragment(new CheeseListFragment(), "我的活动");
            adapter.AddFragment(new CheeseListFragment(), "我的活动");
            adapter.AddFragment(new CheeseListFragment(), "我的活动");
            adapter.AddFragment(new CheeseListFragment(), "我的活动");
        ...
        class Adapter : Android.Support.V4.App.FragmentPagerAdapter
        {
            ...
            public Adapter(V4FragmentManager fm)
                : base(fm)
            {
            }
        ...
        public bool OnNavigationItemSelected(IMenuItem menuItem)
        {
            switch (menuItem.ItemId)
            {
                ...
                case Resource.Id.nav_home:
                    ...
                    break;
                case Resource.Id.nav_messages: viewPager.CurrentItem = 1; break;

                case Resource.Id.nav_friends: viewPager.CurrentItem = 2; break;

                case Resource.Id.nav_discussion: viewPager.CurrentItem = 3; break;
            }
